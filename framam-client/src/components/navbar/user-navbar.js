  ...
  return (
    <div>
        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li tabIndex={0}>
                <Link className="justify-between">How to Recycle</Link>
              </li>
              <li>
                <Link>Recyclable Materials</Link>
              </li>
            </ul>
          </div>
      ...
      <footer className="footer footer-center p-10 bg-base-200 text-base-content rounded">
        ...
        <div>
          <p>Copyright © 2023 - All right reserved by Framam Recycling Ltd</p>
        </div>
      </footer>
    </div>
  );
